...
sl.markdown("[LinkedIn](https://www.linkedin.com/in/lovetteduke)")

sl.markdown("[X-Twitter](https://x.com/lovetteDuke)")

sl.markdown("[Github](https://github.com/Lovette-Duke)")

sl.write("© 2024 Lovette Duke All rights reserved.")
